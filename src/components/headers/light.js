...
export const PrimaryLink = tw(NavLink)`
  lg:mx-0
  px-8 py-3 rounded bg-yellow-500 text-gray-100
  hocus:bg-yellow-700 hocus:text-gray-200 focus:shadow-outline
  border-b-0
`

export const LogoLink = styled(NavLink)`
  ${tw`flex text-yellow-900 items-center font-black border-b-0 text-2xl! ml-0!`};
...
export const NavToggle = tw.button`
  lg:hidden z-20 focus:outline-none text-yellow-500 hocus:text-yellow-700 transition duration-300
`
